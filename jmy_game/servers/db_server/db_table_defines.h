...
static const MysqlTableFieldInfo s_jmy_game_player_table_fields_info[] = {
	...
	{ "vip_level",		MYSQL_FIELD_TYPE_INT,		MYSQL_FIELD_DEFAULT_LENGTH, MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_DEFAULT },
	{ "items",			MYSQL_FIELD_TYPE_BLOB,		MYSQL_FIELD_DEFAULT_LENGTH,	MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_DEFAULT },
	{ "skills",			MYSQL_FIELD_TYPE_BLOB,		MYSQL_FIELD_DEFAULT_LENGTH,	MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_DEFAULT },
	{ "tasks",			MYSQL_FIELD_TYPE_BLOB,		MYSQL_FIELD_DEFAULT_LENGTH,	MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_DEFAULT },
	{ "daily_tasks",	MYSQL_FIELD_TYPE_BLOB,		MYSQL_FIELD_DEFAULT_LENGTH, MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_DEFAULT },
	{ "activities",		MYSQL_FIELD_TYPE_BLOB,		MYSQL_FIELD_DEFAULT_LENGTH,	MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_DEFAULT },
};
