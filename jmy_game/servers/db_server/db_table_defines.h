...
static const MysqlTableFieldInfo s_jmy_game_account_table_fields_info[] = {
	...
	{ "create_time",	MYSQL_FIELD_TYPE_TIMESTAMP,	MYSQL_FIELD_DEFAULT_LENGTH, MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_DEFAULT },
	{ "last_login",		MYSQL_FIELD_TYPE_TIMESTAMP,	MYSQL_FIELD_DEFAULT_LENGTH, MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_DEFAULT },
	{ "last_logout",	MYSQL_FIELD_TYPE_TIMESTAMP,	MYSQL_FIELD_DEFAULT_LENGTH,	MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_DEFAULT },
};
...
static const MysqlTableFieldInfo s_jmy_game_player_table_fields_info[] = {
	{ "id",			MYSQL_FIELD_TYPE_INT,		MYSQL_FIELD_DEFAULT_LENGTH, MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_AUTOINCREMENT|MYSQL_TABLE_CREATE_UNSIGNED },
	{ "uid",		MYSQL_FIELD_TYPE_BIGINT,	MYSQL_FIELD_DEFAULT_LENGTH, MYSQL_INDEX_TYPE_NORMAL,	MYSQL_TABLE_CREATE_UNSIGNED },
	{ "account",	MYSQL_FIELD_TYPE_VARCHAR,	32,							MYSQL_INDEX_TYPE_NORMAL,	MYSQL_TABLE_CREATE_NOT_NULL },
