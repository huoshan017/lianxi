...
static const MysqlTableFieldInfo s_jmy_game_account_table_fields_info[] = {
	...
	{ "last_login",		MYSQL_FIELD_TYPE_TIMESTAMP,	MYSQL_FIELD_DEFAULT_LENGTH, MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_NOT_NULL|MYSQL_TABLE_CREATE_DEFAULT },
	{ "last_logout",	MYSQL_FIELD_TYPE_TIMESTAMP,	MYSQL_FIELD_DEFAULT_LENGTH,	MYSQL_INDEX_TYPE_NONE,		MYSQL_TABLE_CREATE_NOT_NULL|MYSQL_TABLE_CREATE_DEFAULT },
};
