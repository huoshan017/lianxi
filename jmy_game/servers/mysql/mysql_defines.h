...
enum MysqlTableRecordState {
	MYSQL_TABLE_RECORD_STATE_NONE = 0,
	MYSQL_TABLE_RECORD_STATE_INSERT = 1,
	MYSQL_TABLE_RECORD_STATE_DELETE = 2,
	MYSQL_TABLE_RECORD_STATE_UPDATE = 3,
};
...
enum MysqlTableFieldValueState {
	...
	MYSQL_TABLE_FIELD_STATE_COMMITED = 4,
};
